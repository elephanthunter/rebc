...
class BasePairReadKnapsack(object):
    ...
    class BasePairDescriptor(object):
        ...
        def create(position, ref_allele, pileupread):
            ...
            if aligned_pair_positions[0] > position or aligned_pair_positions[-1] < position:
                ...
                return BasePairReadKnapsack.BasePairDescriptor(ref_allele=ref_allele, alt_allele=alt_allele,
            ...
            is_alt = True
            return BasePairReadKnapsack.BasePairDescriptor(ref_allele=ref_allele, alt_allele=alt_allele, is_ref=is_ref,
    ...
    class BasePairAggregateCounts():
        ...
        def create(start, ref_allele, pileupreads, base_pair_descriptors):
            ...
            return BasePairReadKnapsack.BasePairAggregateCounts(num_ref=num_ref, num_alt=num_alt, num_ins=num_ins,
